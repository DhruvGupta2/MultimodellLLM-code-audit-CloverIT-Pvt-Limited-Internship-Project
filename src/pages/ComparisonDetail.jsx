// ComparisonDetail is the parent.
// It fetches, processes, and passes data as props to ResultsDisplay.
// ResultsDisplay just renders the code blocks, metrics, and graphs.
...
const ComparisonDetail = () => {
    ...
    const loadComparison = async () => {
      try {
        ...
        if (docSnap.exists()) {
          ...
          // Process all code entries , 2 types ,string and object
          ...
          // return analysis or empty object
  ...
  // Builds a map like { chatgpt: true, llama: true } for use in ResultsDisplay.
  const selectedModels = comparison.models.reduce((acc, model) => {
    acc[model] = true;
    return acc;
  }, {});
// Creates a flat { modelName: code } object.
