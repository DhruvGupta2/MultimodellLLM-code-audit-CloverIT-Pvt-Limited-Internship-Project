...
const Dashboard = () => {
  ...
  const analyzeResponses = async () => {
    ...
    // If the user is authenticated, the result is saved to Firestore.
    if (user) {
      try {
...
// modelsToUse is just a renamed local alias for newSelectedModels.
  const handleQuerySubmit = async (prompt, modelsToUse) => {
    ...
    // Enables loading state and prepares per-model loading flags.
    try {
    // Prepares arrays for pending requests and selected models.
      const requests = [];
      const requestModels = [];
      ...
      // Creates a shallow copy of the previous responses object to avoid direct mutation.
      setResponses(prev => {
  ...
  return (
    <div className="dashboard-container">
      ...
      <main className="dashboard-content">
        ...
        {/* If loading, a spinner is shown. Otherwise, results are passed to ResultsDisplay. */}
        {loading ? (
